  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        brand:
          "bg-gradient-brand text-primary-foreground shadow-soft hover:shadow-lift hover:brightness-105",
        accent:
          "bg-accent text-accent-foreground shadow-soft hover:shadow-lift hover:brightness-105",
        outline:
          "border border-border bg-background hover:bg-muted hover:text-foreground",
        secondary:
          "bg-secondary text-secondary-foreground shadow-soft hover:brightness-105",
