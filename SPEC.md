# CampusGig — Technical Specification

> Production-level technical specification for the CampusGig student skill-based marketplace.  
> This document translates [`PLAN.md`](./PLAN.md) into concrete, implementable engineering specifications.

**Document version:** 2.0  
**Last updated:** 2026-06-13  
**Status:** 🚀 Engineering specification — In implementation  
**Companion documents:** [`README.md`](./README.md) (overview) · [`PLAN.md`](./PLAN.md) (product plan)
...
- **Serverless + BaaS:** Next.js on Vercel, Supabase for DB/Auth/Storage/Realtime, Razorpay for payments
- **Security-first:** Row-Level Security (RLS) on all tables, server-side validation, JWT sessions
- **Payment integrity:** Razorpay webhooks are the source of truth; idempotent, transactional ledger; escrow state machine
- **Realtime:** Supabase Realtime for chat, notifications, and task status (WebSocket channels)
- **Campus-scoped:** Default campus-level isolation for scalability and trust
...
- **[PLAN.md](./PLAN.md)** — Product vision, features, roadmap, and timeline
- **[SPEC.md](./SPEC.md)** — Technical specification (this document)
- **[supabase/migrations/](./supabase/migrations/)** — Database schema migrations
- **[components/](./components/)** — React UI component library
- **[features/](./features/)** — Feature-specific business logic and components
- **[lib/](./lib/)** — Shared utilities, services, and repositories

---

<div align="center">

**Questions? See the [README](./README.md) for support options.**

_This specification is a living document — it evolves with the codebase. Last updated: 2026-06-13._
